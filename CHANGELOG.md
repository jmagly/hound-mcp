...
- Disable GitHub OIDC provenance only for the authenticated internal Gitea mirror while retaining it for npmjs.org.

## [2026.8.37] - 2026-08-29

### Fixed
- Reconciled the scoped AppRole and reached the internal registry; Gitea cannot issue GitHub OIDC provenance, so this candidate was not published.
